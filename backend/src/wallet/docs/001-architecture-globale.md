...
Le package du projet contient TypeORM et Prisma, mais les fichiers utilisateurs fournis utilisent TypeORM avec `DataSourceResolver`. Ce starter s’aligne donc sur TypeORM pour rester cohérent avec l’existant.
