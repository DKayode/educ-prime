...
import { CreditWalletFromValidatedExamUseCase } from '../wallet/use-cases/credit-wallet-from-validated-exam.use-case';
import { CreditWalletFromExamDto } from '../wallet/dto/credit-wallet-from-exam.dto';
