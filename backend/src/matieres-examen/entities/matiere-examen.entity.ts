...
@Entity('matieres_examen')
export class MatiereExamen {
    @ApiProperty({ description: 'ID unique de la matière' })
    ...
    @ApiProperty({ description: 'Nom de la matière (Anglais, Mathématiques, Droit Civil…)' })
    @Column()
    nom: string;
